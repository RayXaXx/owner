...
if wget -q https://github.com/RayXaXx/owner/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/RayXaXx/owner.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} RayXaXx-BOT${b}: "
	read opcion
	case $opcion in
            01|1)
...
echo -e "\033[01;32m\033[01mIniciando RayXaXx-BOT!!\n\033[0m"
npm start