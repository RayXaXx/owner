...
const smsOfc1 = () => { return ''}
const smsOfc2 = () => { return ``}

//info-donar.js
const smsMensajeDonar = () => { return `Se acepta apoyo voluntario, este bot se creo con fines de entretenimirnto para un grupo de compañeros YAPE 976254398`}
const smsTituloDonar = () => { return '*DONACIÓN VOLUNTARIA MRD*'}
const smsPrivadoDonar = () => { return 'Puedes yapearme si gustas 976254398'}

//info-gruposofc.js
const smsGrupoOfc1 = () => { return ''}
const smsGrupoOfc2 = () => { return ''}
...
const smsEstado6 = () => { return 'Usuarios/as Prohibidos'}
...
const smsContacto4 = () => { return 'Contacto Oficial de RayXaXx 🤖'}
