...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '©𝙷𝙰𝙳𝙴𝚂-𝙱𝙾𝚃-𝙾𝙼𝙴𝙶𝙰﹏', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/RayXaXx/owner' }, mentionedJid: [m.sender]}}}, aa)    
