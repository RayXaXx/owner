...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: texto, contextInfo: { externalAdReply: { title: '©RayXaXx', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/RayXaXx/owner' }, mentionedJid: [m.sender]}}}, aa)    
